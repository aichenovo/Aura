...
class _PluginEditorPageState extends State<PluginEditorPage> {
  ...
  void initState() {
    ...
    useWebviewForPages = plugin.useWebviewForPages;
            ...
            child: Column(
              children: [
                ...
                ExpansionTile(
                  ...
                  children: [
                    SwitchListTile(
                      title: const Text('WebView 抓页面'),
                      subtitle: const Text('使用 WebView 获取页面 HTML（适用于人机验证/WAF）'),
                      value: useWebviewForPages,
                      onChanged: (bool value) {
                        setState(() {
                          useWebviewForPages = value;
                        });
                      },
                    ),
                    SwitchListTile(
        ...
        children: [
          FloatingActionButton(
            ...
            onPressed: () async {
              Plugin pluginText = Plugin(
                  ...
                  useWebviewForPages: useWebviewForPages,
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              ...
              plugin.useWebviewForPages = useWebviewForPages;
