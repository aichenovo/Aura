...
import 'package:aura/bean/widget/collect_button.dart';
...
import 'package:aura/pages/info/info_controller.dart';
import 'package:aura/bean/card/bangumi_info_card.dart';
import 'package:aura/pages/info/source_sheet.dart';
...
import 'package:aura/pages/info/info_tabview.dart';
...
class _InfoPageState extends State<InfoPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final List<String> tabs = <String>['概览', '影评', '演员', '制作人员'];
                  ...
                  sliver: SliverAppBar.medium(
                    ...
                    actions: [
                      ...
                      EmbeddedNativeControlArea(
                        child: IconButton(
                          onPressed: () {
                            final isTv = infoController.bangumiItem.type == 2;
                            launchUrl(
                              Uri.parse(
                                  'https://www.themoviedb.org/${isTv ? 'tv' : 'movie'}/${infoController.bangumiItem.id}'),
