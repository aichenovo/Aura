...
import 'package:aura/request/query_manager.dart';
...
class _SourceSheetState extends State<SourceSheet>
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> sourceTypes = pluginsController.pluginList
        .map((p) => p.type)
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      ...
                      ...sourceTypes.expand((t) sync* {
                        yield FilterChip(
                          label: Text(typeLabels[t] ?? t),
                          selected: selectedSourceType == t,
                          onSelected: (_) {
                            setState(() {
                              selectedSourceType = t;
                            });
                            final index = pluginsController.pluginList
                                .indexWhere((p) => p.type == t);
                            if (index >= 0) {
