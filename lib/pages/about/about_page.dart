...
class _AboutPageState extends State<AboutPage> {
  final exitBehaviorTitles = <String>['退出 Aura', '最小化至托盘', '每次都询问'];
        ...
        body: SettingsList(
          ...
          sections: [
            ...
            SettingsSection(
              ...
              tiles: [
                SettingsTile.navigation(
                  title: Text('作者', style: TextStyle(fontFamily: fontFamily)),
                  value: Text('E.空', style: TextStyle(fontFamily: fontFamily)),
                ),
                SettingsTile.navigation(
                  onPressed: (_) {
                    launchUrl(Uri.parse('https://t.me/Ekong_H'),
                        mode: LaunchMode.externalApplication);
                  },
                  title: Text('联系方式', style: TextStyle(fontFamily: fontFamily)),
