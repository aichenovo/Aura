...
import 'package:aura/pages/search/search_controller.dart';
  ...
  void initState() {
    ...
    if (widget.inputTag != '') {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        final String query = Uri.decodeComponent(widget.inputTag);
